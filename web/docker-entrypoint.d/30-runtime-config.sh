...
: "${SKILLHUB_WEB_AUTH_TRUSTED_HEADER_ENABLED:=false}"
: "${SKILLHUB_WEB_AUTH_TRUSTED_HEADER_LOGOUT_URL:=}"

# Generate runtime-config.js
envsubst '${SKILLHUB_WEB_API_BASE_URL} ${SKILLHUB_PUBLIC_BASE_URL} ${SKILLHUB_WEB_AUTH_DIRECT_ENABLED} ${SKILLHUB_WEB_AUTH_DIRECT_PROVIDER} ${SKILLHUB_WEB_AUTH_SESSION_BOOTSTRAP_ENABLED} ${SKILLHUB_WEB_AUTH_SESSION_BOOTSTRAP_PROVIDER} ${SKILLHUB_WEB_AUTH_SESSION_BOOTSTRAP_AUTO} ${SKILLHUB_WEB_AUTH_TRUSTED_HEADER_ENABLED} ${SKILLHUB_WEB_AUTH_TRUSTED_HEADER_LOGOUT_URL}' \
